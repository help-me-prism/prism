...
- 문장·수식·페이지 태그는 `[@문장24]`처럼 채팅 문장 안에 삽입되며 논문 ID, 페이지, 원문 구조도 함께 CLI에 전달됩니다.
- 피겨 태그 모드에서 PDF 영역을 드래그하면 PNG와 좌표 메타데이터로 별도 저장하고 채팅에 바로 태그합니다.
...
현재 다음 단계는 LaTeX 구조를 직접 이용한 더 정교한 문단·피겨 자동 인식, 앵커별 노트 블록, 논문 간 연결 그래프입니다.
