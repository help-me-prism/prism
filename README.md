...
- 문단 경계를 우선한 병렬 번역. 작업별 AI 설정에서 논문당 1–3개를 선택하며, 같은 CLI의 번역·요약·정리 작업은 여러 논문을 합쳐 최대 3개 동시 실행
...
대화의 자동 연구 기억은 사용자 발언의 원문 근거가 있는 변경만 적용합니다. 기존 기억은 응답에서 빠졌다는 이유로 삭제하지 않으며, 직접 수정·삭제한 항목은 보호합니다. 모델 사용 위치, 병렬 처리 판단, 메모리 프롬프트와 실제 평가 결과는 [AI 하네스 검토](docs/AI_HARNESS_REVIEW.md)에 정리했습니다.
