...
type CurationQueue = { pendingRelations: CurationPendingRelation[]; stubs: CurationStub[]; memos: CurationMemo[]; unsupportedClaims: KnowledgeNodeRecord[]; unansweredQuestions: KnowledgeNodeRecord[]; conflicts: CurationConflict[]; conceptSuggestions: CurationConceptSuggestion[]; modelRuns: ModelSuggestionSummary[]; total: number }
...
type ConflictingPaperPair = { relationId: string; left: KnowledgeNodeRecord; right: KnowledgeNodeRecord; claim?: KnowledgeNodeRecord }
