...
type KnowledgeNodeRecord = { id: string; title: string; nodeType: KnowledgeNodeType; status: KnowledgeStatus; readingStatus?: KnowledgeReadingStatus; importance: KnowledgeLevel; confidence: KnowledgeLevel; templateId?: string; preview: string; evidenceCount: number; relativePath: string; revision: string; modifiedAt: number }
...
type KnowledgePropertyPatch = { status?: KnowledgeStatus; readingStatus?: KnowledgeReadingStatus; importance?: KnowledgeLevel; confidence?: KnowledgeLevel }
type KnowledgeBacklink = { nodeId: string; title: string; nodeType: KnowledgeNodeType; relativePath: string; excerpt: string }
type KnowledgeRelationType = 'discusses' | 'presents' | 'supports' | 'contradicts' | 'extends' | 'uses' | 'explains' | 'evidence_for' | 'derived_from' | 'raises' | 'related'
