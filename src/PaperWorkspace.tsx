...
function PdfPage({ document: pdfDocument, pageNumber, scale, segments, translation, mode, highlighted, figureSelect, sourceFigures, onHighlight, onTag, onVisible, onFigure }: {
